...
namespace Entidades
{
    ...
    public sealed class Taller
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static string ToString(Taller taller)
        {
            return Taller.Listar(taller, ETipo.Todos);
        }
        #endregion
        ...
        public static string Listar(Taller t, ETipo tipo)
        {
            ...
            sb.AppendLine($"Tenemos {t.vehiculos.Count} lugares ocupados de un total de {t.espacioDisponible} disponibles");
            sb.AppendLine("");
